...
export default function AuthPages({ onLoginSuccess, initialMode = "login" }: AuthPagesProps) {
  ...
  return (
<div className="min-h-screen rounded-[32px] overflow-hidden bg-slate-950 flex flex-col items-center justify-center px-4 py-8 relative">      
      ...
      {/* Main card box */}
      <div className="w-full max-w-lg glass-effect rounded-[30px] border border-white/5 shadow-2x">
